...
public class ForgotPassword extends javax.swing.JFrame{
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            if(controller.checkUserExistence(this)){
                JOptionPane.showMessageDialog(this, "User found!" , "Success", JOptionPane.INFORMATION_MESSAGE);
            }
        }
        catch (Exception ex) {
            controller.showErrorEmail(ex, this);
        }
    }//GEN-LAST:event_jButton1ActionPerformed
    public void showQuestionWindow(String question, AnswerQuestionController controller){
